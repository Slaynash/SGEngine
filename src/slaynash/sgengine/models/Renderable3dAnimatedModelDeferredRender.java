...
public class Renderable3dAnimatedModelDeferredRender implements DeferredModelRenderer {

	private Renderable3dAnimatedModel model;
	...
	public void bindModel(Object model) {
		this.model = (Renderable3dAnimatedModel) model;
