/*
 * This class is from the ThinMatrix OpenGL 3d Game Tutorial #45
 */
...
public class FrameBufferedObject {
	 ...
	 *            this FBO should use without multisample. With multisample depthBufferType is always DEPTH_RENDER_BUFFER.
	 * @param multisample
	 *            - set this FBO multisample or not.
	 * @param samples
	 *            - the number of multisample samples
	 * @param glRgba16f 
	 */
	public FrameBufferedObject(int width, int height, int depthBufferType, boolean multisample, int samples, int colorbufferFormat) {
		this.width = width;
		this.height = height;
		this.multisample = multisample;
		this.samples = multisample ? samples : 1;
		this.colorbufferFormat = colorbufferFormat;
		initialiseFrameBuffer(multisample ? DEPTH_RENDER_BUFFER : depthBufferType);
	}
	...
	public void resolveToFbo(FrameBufferedObject outputFbo) {
	...
	private void createTextureAttachment() {
		...
		GL11.glTexImage2D(GL11.GL_TEXTURE_2D, 0, colorbufferFormat, width, height, 0, GL11.GL_RGBA, GL11.GL_UNSIGNED_BYTE,
				(ByteBuffer) null);
	...
	private void createMultisampleColourAttachment() {
		...
		GL30.glRenderbufferStorageMultisample(GL30.GL_RENDERBUFFER, samples, colorbufferFormat, width, height);
