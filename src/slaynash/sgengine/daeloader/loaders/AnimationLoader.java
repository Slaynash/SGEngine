package slaynash.sgengine.daeloader.loaders;
...
import slaynash.sgengine.daeloader.animation.JointTransform;
import slaynash.sgengine.daeloader.animation.KeyFrame;
import slaynash.sgengine.daeloader.animation.Quaternion;
...
import slaynash.sgengine.daeloader.dataStructures.JointTransformData;
import slaynash.sgengine.daeloader.dataStructures.KeyFrameData;
...
public class AnimationLoader {
	 ...
	 */
	public static Animation loadAnimation(String colladaFilePath) {
		AnimationData animationData = ColladaLoader.loadColladaAnimation(new File(Configuration.getAbsoluteInstallPath()+"/"+colladaFilePath));
